...
struct QuestionCompleteCellModel {
    let question: String
    let answer: String
    let isOpened: Bool
}

final class QuestionCompleteCell: AnimateCollectionViewCell {
    ...
    func setup(model: QuestionCompleteCellModel) {
